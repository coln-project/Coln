...
Geolog is a quite ambitious project. However, we believe that it is feasible to do \emph{without developing a large amount of new mathematics or ``theory A'' computer science}. That is, we believe that geolog is mainly a \emph{programming languages and software engineering} challenge, and very few substially new
\begin{itemize}
\item ``semantic'' theorems (as opposed to type theory theorems)
\item algorithms
