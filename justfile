...
generated_file_pathspecs := "':(exclude,glob)packages/coln-compiler/test/golden/basic-ir/*.ts.output/**' ':(exclude,glob)packages/coln-compiler/test/golden/*.ts.output/**' ':(exclude,glob)examples/lab/src/tools/graph/generated/**' ':(exclude,glob)examples/patchwork/src/graph/generated/**'"
