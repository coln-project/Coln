...
import * as LookupFieldProjectionRealm from "../../../coln-compiler/test/golden/basic-ir/lookup-field-projection.ts.output/TRealm.ts";
import { beginRealm } from "./helpers.ts";

test("lookup-field-projection", () => {
  const realm = beginRealm(LookupFieldProjectionRealm);
